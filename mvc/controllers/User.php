    ...
    public function add_user()
    {
        ...
        if (isset($_POST['add_user']) && ($_POST['add_user'])) {
            ...
            if ($check == 1) {
                ...
                $status = $this->user->insert($name, $avatar, $email, $password, $phone, $address, $desc, $created_at);
                if ($status) {
                    $type = 'success';
    ...
    function update_user($id)
    {
        ...
        if (isset($_POST['update_user']) && ($_POST['update_user'])) {
            ...
            if ($check == 1) {
                ...
                $status = $this->user->updateUser($id, $name, $avatar, $email, $password, $phone, $address, $desc, $updated_at);
                if ($status) {
                    $header = 1;
                    $type = 'success';
