            ...
            <div class="row align-items-center">
                <div class="header-logo col-2">
                    <a href="<?= _WEB_ROOT . '/home' ?>" class="logo-link text-center">
                        <img src="<?= _PATH_IMG_PUBLIC ?>01.jpg" alt="" class="logo-img">
                    </a>
                </div>
                    ...
                    <div class="menu-top">
                        <ul class="list-top d-flex p-2 list-unstyled">
                            ...
                            <li class="list-top-item header-search">
                                <form action="<?= _WEB_ROOT . '/product/show_product' ?>" method="GET"
                                    class="header-search-form input-group">
                                    <input type="text" class="input-search form-control" placeholder="Tìm sản phẩm..."
                                    ...
                                    <div class="header-search-history">
                                        ...
                                        <ul class="header-search-history-list">
                                            <li class="header-search-hisroty-item">
                                                <a href="http://localhost/Công NghệSHOP/product/show_product?cate=1">Tay
                                                    cầm
                                                    chơi game chính hãng</a>
                                            </li>
                                            <li class="header-search-hisroty-item">
                                                <a href="">Chuột gaming chính hãng</a>
                                            </li>
                                            <li class="header-search-hisroty-item">
                        ...
                        <a href="#" class="a-header-right header-account-link">
                            <span class="box-icon">
                                ...
                                <img class=" rounded-circle"
                                    src="<?= _WEB_ROOT . '/upload/avt/' . $_SESSION['user']['avatar'] ?> " alt=""
                                    style="width: 30px; height: 30px; max-width: 100%; object-fit: cover; object-position: center; margin-bottom: 5px;">
                                <?php
                                } else {
                                ?>
                            ...
                            <ul class="header-account-option">
                                ...
                                <li class="option-select">
                                    <a href="<?php if ($_SESSION['user']['gr_id'] == 1) echo _WEB_ROOT . '/admin';
                                                    else echo _WEB_ROOT . '/user/profile' ?>"
                                        class="a-option d-flex m-0 justify-content-center">
                                        <i class="fa-solid fa-user-check"></i>
                                        <span class=""
                                            style="white-space: nowrap;"><?php echo $_SESSION['user']['name'] ?></span>
                                    </a>
                                </li>
                                <li class="option-select">
                        ...
                        <div class="header-cart-list">
                            ...
                            <ul class="header__cart-list-item">
                                ...
                                <li class="header__cart-item">
                                    <img src="<?= _PATH_IMG_PRODUCT . $item['image'] ?>" alt=""
                                        ...
                                        <div class="header__cart-item-head">
                                            ...
                                            <div class="header__cart-item-price-wrap">
                                                <span class="header__cart-item-price"
                                                    name="qty[<?= $item['id'] ?>]"><?= numberFormat($item['price']) ?></span>
                            ...
                            <div class="d-flex justify-content-end m-3">
                                <?php
                                    ...
                                    ?>
                                <a class="outline-main fs-4 p-2 me-4" href="<?= _WEB_ROOT . '/bill/show_bill' ?>">Đơn
                                    hàng của tôi</a>
                                <?php
                                    }
                                    ?>
                            ...
                            <?php
                                if (!empty($_SESSION['user']['gr_id'])) {
                                ?>
                            <div class="d-flex justify-content-center mb-3"><a class="outline-main p-3 fs-4"
                                    href="<?= _WEB_ROOT . '/bill/show_bill' ?>">ĐƠN HÀNG CỦA TÔI</a></div>
                            <?php } ?>
                            <?php }
                            ?>
                        </div>
            ...
            <ul class="nav-list list-unstyled d-flex justify-content-around">
                ...
                <li class="nav-item header-has-menu-product">
                    <a class="nav-link <?php
                                        if ($data['page'] == 'product') echo 'active-header-nav' ?>"
                        href="<?= _WEB_ROOT . '/product/show_product' ?>">SẢN PHẨM
                    ...
                    <div class="header-menu-product fadein-list">
                        ...
                        <ul class="">
                            ...
                            ?>
                            <li class=" ">
                                <a class="header-heading-product"
                                    href="<?php echo _WEB_ROOT . '/product/show_product?cate=' . $category['id_cate'] ?>"><?= $category['name'] ?></a>
                            </li>
                            <?php
                            }
                            ?>
                ...
                <li class="nav-item"><a class="nav-link 
                        <?php
                        if ($data['page'] == 'introduce') echo 'active-header-nav' ?>"
                        href="<?= _WEB_ROOT . '/introduce' ?>">GIỚI THIỆU</a></li>
                <li class="nav-item"><a class="nav-link 
                        <?php
                        if ($data['page'] == 'contact') echo 'active-header-nav' ?>"
                        href="<?= _WEB_ROOT . '/contact' ?>">LIÊN HỆ</a></li>
            </ul>
        </div>
    </nav>
