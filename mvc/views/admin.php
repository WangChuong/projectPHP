...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= _WEB_ROOT ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Shop công nghệ</span>
            </a>
          ...
          <img src="dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                    ...
                    <div class="info">
                        <a href="<?php echo _WEB_ROOT . "/admin" ?>" class="d-block">ADMIN</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="<?php echo _WEB_ROOT . "/user" ?>"
                                class="nav-link <?php if ($data['page'] == 'user/list') echo 'active' ?>">
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script
        src="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->
    <script src="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/summernote/summernote-bs4.min.js"></script>
    <!-- overlayScrollbars -->
    <script
        src="<?php echo _PATH_ROOT_PUBLIC . "/admin/" ?>plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js">
    </script>
    <!-- AdminLTE App -->
