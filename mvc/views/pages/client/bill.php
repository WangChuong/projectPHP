            ...
            <div class="bill-section mb-5 border-main" data-aos="fade-left">
                ...
                <ul class="fs-4 bill-list-pro">
                    ...
                    <li class="row mx-3 p-3 bill-item-pro">
                        <!-- <td><?= $item['id'] ?></td> -->
                        <div class="col-2">
                            <img class="border-main" src="<?= _PATH_IMG_PRODUCT . $item['image'] ?>" alt=""
                                style="width: 60px; height: 60px;  max-width: 100%; object-fit: cover; object-position: center;">
                        </div>
                        <div class="col-8">
                            <a href="<?= _WEB_ROOT . '/detailproduct/product/' . $item['id_pro']  ?>" title=""
                                class="name-product "><?= $item['name_pro'] ?></a>
                            <span class="d-block">x <?= $item['qty'] ?></span>
                        </div>
                        <div class="text-color-primary col-2 d-flex justify-content-end align-items-md-center">
                            <?= numberFormat($item['price']) ?></div>
                        <div>
                        </div>
                    </li>
                    <?php
