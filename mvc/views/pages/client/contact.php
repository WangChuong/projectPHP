...
<div class="grid wide">
    ...
    <div class="row p-3 pt-0">
        ...
        <div class="contact-form col-lg-6" data-aos="fade-right">
            <div class="contact-heading">
                ...
                <div class="time_work">
                    <div class="contact-item">
                        <b>Hotline:</b>
                        <a class="fone" href="tel:0938744376" title="0333932605">0333932605</a>
                    </div>
                    <div class="contact-item">
                        <b>Email:</b>
                        <a href="mailto:quangtruongle369@gmail.com"
                            title="quangtruongle369@gmail.com">quangtruongle369@gmail.com</a>
                    </div>
            ...
            <form method="post" class="bg-form-control p-3 border-radius-main border-main">
                <div class="row contact-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <input type="text" placeholder="Điện thoại" name="so_dt" class=" form-control form-control-lg"
                            required="">
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <input placeholder="Email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
                            required="" id="email1" class=" form-control form-control-lg" value="" name="email">
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <textarea placeholder="Nội dung" name="noi_dung" id="comment"
                            class=" form-control form-control-lg" rows="2" required=""></textarea>
        ...
        <div class="map user-select-none col-lg-6 " data-aos="fade-left">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.12656157246!2d106.71226721458926!3d10.801617492304434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528a459cb43ab%3A0x6c3d29d370b52a7e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVFAuSENNIC0gSFVURUNI!5e0!3m2!1svi!2s!4v1676012505186!5m2!1svi!2s"
