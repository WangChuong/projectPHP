    ...
    <div class="grid wide">
        ...
        <section class="product-tabs" data-aos="fade-up">
            <div class="row content-heading">
                <a href="<?= _WEB_ROOT . '/product/show_product?cate=' . $category['id_cate'] ?>"
                    class="content-name col-lg-4"><?php echo $category['name'] ?></a>
                <div class="product-other-components col-lg-8">
                </div>
            </div>
            <div class="product-section row">
                <div class="product-guide-use col-lg-3">
                    <div class="product-guide-use-body"
                        style="background-image: url(<?= _PATH_IMG_PUBLIC . './slide/1.png' ?>);">
                ...
                <div class="product-list-item col-lg-9">
                    <div id="" class="content-list-item-body">
                        ...
                        <div class="product-item col-lg-3">
                            <a href="<?= _WEB_ROOT . '/detailproduct/product/' . $product['id'] ?>"
                                ...
                                <div class="home-product-item-body">
                                    ...
                                    <div class="home-product-item__price">
                                        <span
                                            class="home-product-item__price-current"><?= numberFormat($product['price']) ?></span>
                                    </div>
