    ...
    <div class="grid-cols-12 grid gap-4 row">
        <div class="col">
            ...
            <div class="mb-3 col-span-6 " id="avatar-upload">
                ...
                <img class=" my-2 img-thumbnail" src="<?php echo _PATH_AVATAR . $data['user']['avatar'] ?>" alt=""
                    id="img-preview" style="object-fit: cover; object-position: center; width: 100px; height: 100px">
                <?php } ?>
        ...
        <div class="col">
            ...
            <div class="mb-3 col-span-6">
                ...
                <textarea rows="4" type="text" class="form-control" name="address"
                    placeholder="Địa chỉ"><?php echo $data['user']['address'] ?></textarea>
            </div>
            <div class="mb-3 col-span-6">
                ...
                <textarea rows="4" type="text" class="form-control" name="description"
                    placeholder="Giới thiệu"><?php echo $data['user']['description'] ?></textarea>
            </div>
        </div>
